...
class fase1 extends Phaser.Scene{
    ...
    create (){
        ...
        this.morcego.createMorcego(1000,205);
        this.morcego.createMorcego(555,205);
        this.morcego.createMorcego(1200,205);
        this.morcego.createMorcego(1450,205);
        this.morcego.createMorcego(1500,205);
        this.morcego.createMorcego(1745,205);
        this.morcego.createMorcego(1950,205);
        this.morcego.createMorcego(2000,205);
        this.morcego.createMorcego(2300,205);
        this.morcego.createMorcego(2470,205);
