...
class fase1 extends Phaser.Scene{
    ...
    create (){
        ...
        this.morcego.createMorcego(1000,25,150);
        this.morcego.createMorcego(555,25,150);
        this.morcego.createMorcego(1200,25,150);
        this.morcego.createMorcego(1450,25,150);
        this.morcego.createMorcego(1500,25,150);
        this.morcego.createMorcego(1745,25,150);
        this.morcego.createMorcego(1950,25,150);
        this.morcego.createMorcego(2000,25,150);
        this.morcego.createMorcego(2300,25,150);
        this.morcego.createMorcego(2470,25,150);
        this.morcego.createMorcego(2520,25,150);
        this.morcego.createMorcego(2600,25,150);
        this.morcego.createMorcego(2650,25,150);
